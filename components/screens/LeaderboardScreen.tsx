    ...
    return (
        <div className="p-4 md:p-6">
            <div className="flex justify-center items-center mb-6 text-center">
                <h2 className="font-graffiti text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-orange-400 tracking-wide title-glow-cyan">
                    Ranking
                </h2>
            </div>
            {loading ? (
