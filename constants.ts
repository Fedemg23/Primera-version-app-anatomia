...
export const achievementsData: Achievement[] = [
    {
        ...
        tiers: [
            { rank: 'bronze', level: 1, description: 'Completa 5 cuestionarios.', target: 5, reward: { bones: 50, xp: 100 } },
            { rank: 'silver', level: 2, description: 'Completa 15 cuestionarios.', target: 15, reward: { bones: 100, xp: 200 } },
            { rank: 'gold', level: 3, description: 'Completa 50 cuestionarios.', target: 50, reward: { bones: 250, xp: 500 } },
            { rank: 'ruby', level: 4, description: 'Completa 150 cuestionarios.', target: 150, reward: { bones: 500, xp: 1000 } },
            { rank: 'emerald', level: 5, description: 'Completa 500 cuestionarios.', target: 500, reward: { bones: 1000, xp: 2000 } },
            { rank: 'diamond', level: 6, description: 'Completa 1000 cuestionarios.', target: 1000, reward: { bones: 2000, xp: 4000 } },
        ],
    ...
    },
    {
        ...
        action: { type: 'view', value: 'home' },
        tiers: [
            { rank: 'bronze', level: 1, description: 'Consigue 3 tests perfectos.', target: 3, reward: { bones: 100, xp: 250 } },
            { rank: 'silver', level: 2, description: 'Consigue 10 tests perfectos.', target: 10, reward: { bones: 250, xp: 500 } },
            { rank: 'gold', level: 3, description: 'Consigue 25 tests perfectos.', target: 25, reward: { bones: 600, xp: 1500 } },
            { rank: 'ruby', level: 4, description: 'Consigue 50 tests perfectos.', target: 50, reward: { bones: 1200, xp: 3000 } },
            { rank: 'emerald', level: 5, description: 'Consigue 100 tests perfectos.', target: 100, reward: { bones: 2500, xp: 6000 } },
            { rank: 'diamond', level: 6, description: 'Consigue 250 tests perfectos.', target: 250, reward: { bones: 5000, xp: 12000 } },
        ],
    ...
    },
    {
        ...
        icon: '🗺️',
        tiers: [
            { rank: 'bronze', level: 1, description: 'Alcanza el nivel 5.', target: 5, reward: { bones: 50 } },
            { rank: 'silver', level: 2, description: 'Alcanza el nivel 10.', target: 10, reward: { bones: 150 } },
            { rank: 'gold', level: 3, description: 'Alcanza el nivel 20.', target: 20, reward: { bones: 400 } },
            { rank: 'ruby', level: 4, description: 'Alcanza el nivel 30.', target: 30, reward: { bones: 800 } },
            { rank: 'emerald', level: 5, description: 'Alcanza el nivel 40.', target: 40, reward: { bones: 1500 } },
            { rank: 'diamond', level: 6, description: 'Alcanza el nivel 50.', target: 50, reward: { bones: 3000 } },
        ],
    ...
    },
    {
        ...
        icon: 'llama',
        tiers: [
            { rank: 'bronze', level: 1, description: 'Mantén una racha de 3 días.', target: 3, reward: { bones: 50, xp: 100 } },
            { rank: 'silver', level: 2, description: 'Mantén una racha de 7 días.', target: 7, reward: { bones: 150, xp: 300 } },
            { rank: 'gold', level: 3, description: 'Mantén una racha de 14 días.', target: 14, reward: { bones: 500, xp: 1000 } },
            { rank: 'ruby', level: 4, description: 'Mantén una racha de 30 días.', target: 30, reward: { bones: 1000, xp: 2000 } },
            { rank: 'emerald', level: 5, description: 'Mantén una racha de 60 días.', target: 60, reward: { bones: 2500, xp: 5000 } },
            { rank: 'diamond', level: 6, description: 'Mantén una racha de 100 días.', target: 100, reward: { bones: 5000, xp: 10000 } },
        ],
    ...
    },
    {
        ...
        tiers: [
            { rank: 'bronze', level: 1, description: 'Gasta 1,000 Huesitos.', target: 1000, reward: { xp: 200 } },
            { rank: 'silver', level: 2, description: 'Gasta 5,000 Huesitos.', target: 5000, reward: { xp: 500 } },
            { rank: 'gold', level: 3, description: 'Gasta 15,000 Huesitos.', target: 15000, reward: { xp: 1200 } },
            { rank: 'ruby', level: 4, description: 'Gasta 30,000 Huesitos.', target: 30000, reward: { xp: 2500 } },
            { rank: 'emerald', level: 5, description: 'Gasta 60,000 Huesitos.', target: 60000, reward: { xp: 5000 } },
            { rank: 'diamond', level: 6, description: 'Gasta 100,000 Huesitos.', target: 100000, reward: { xp: 8000 } },
        ],
    ...
    },
    {
        ...
        icon: '🧑‍🏫',
        tiers: [
            { rank: 'bronze', level: 1, description: 'Responde 250 preguntas correctamente.', target: 250, reward: { bones: 50, xp: 100 } },
            { rank: 'silver', level: 2, description: 'Responde 1,000 preguntas correctamente.', target: 1000, reward: { bones: 150, xp: 300 } },
            { rank: 'gold', level: 3, description: 'Responde 2,500 preguntas correctamente.', target: 2500, reward: { bones: 400, xp: 800 } },
            { rank: 'ruby', level: 4, description: 'Responde 5,000 preguntas correctamente.', target: 5000, reward: { bones: 800, xp: 1600 } },
            { rank: 'emerald', level: 5, description: 'Responde 10,000 preguntas correctamente.', target: 10000, reward: { bones: 1600, xp: 3200 } },
            { rank: 'diamond', level: 6, description: 'Responde 25,000 preguntas correctamente.', target: 25000, reward: { bones: 3200, xp: 6400 } },
        ],
    ...
    },
    {
        ...
        tiers: [
            { rank: 'bronze', level: 1, description: 'Desbloquea 3 avatares.', target: 3, reward: { bones: 50, xp: 100 } },
            { rank: 'silver', level: 2, description: 'Desbloquea 6 avatares.', target: 6, reward: { bones: 100, xp: 200 } },
            { rank: 'gold', level: 3, description: 'Desbloquea 10 avatares.', target: 10, reward: { bones: 200, xp: 400 } },
            { rank: 'ruby', level: 4, description: 'Desbloquea 15 avatares.', target: 15, reward: { bones: 400, xp: 800 } },
            { rank: 'emerald', level: 5, description: 'Desbloquea 20 avatares.', target: 20, reward: { bones: 800, xp: 1600 } },
            { rank: 'diamond', level: 6, description: 'Desbloquea todos los avatares.', target: AVATAR_DATA.length, reward: { bones: 1600, xp: 3200 } },
        ],
    ...
    },
    {
        ...
        tiers: [
            { rank: 'bronze', level: 1, description: 'Completa 5 desafíos diarios.', target: 5, reward: { bones: 50, xp: 100 } },
            { rank: 'silver', level: 2, description: 'Completa 15 desafíos diarios.', target: 15, reward: { bones: 150, xp: 300 } },
            { rank: 'gold', level: 3, description: 'Completa 30 desafíos diarios.', target: 30, reward: { bones: 400, xp: 800 } },
            { rank: 'ruby', level: 4, description: 'Completa 50 desafíos diarios.', target: 50, reward: { bones: 800, xp: 1600 } },
            { rank: 'emerald', level: 5, description: 'Completa 100 desafíos diarios.', target: 100, reward: { bones: 1600, xp: 3200 } },
            { rank: 'diamond', level: 6, description: 'Completa 200 desafíos diarios.', target: 200, reward: { bones: 3200, xp: 6400 } },
        ],
    ...
    },
    {
        ...
        action: { type: 'view', value: 'home' },
        tiers: [
            { rank: 'bronze', level: 1, description: 'Domina 1 región por completo.', target: 1, reward: { bones: 100, xp: 200 } },
            { rank: 'silver', level: 2, description: 'Domina 2 regiones por completo.', target: 2, reward: { bones: 250, xp: 500 } },
            { rank: 'gold', level: 3, description: 'Domina 4 regiones por completo.', target: 4, reward: { bones: 600, xp: 1200 } },
            { rank: 'ruby', level: 4, description: 'Domina 6 regiones por completo.', target: 6, reward: { bones: 1200, xp: 2400 } },
            { rank: 'emerald', level: 5, description: 'Domina 8 regiones por completo.', target: 8, reward: { bones: 2500, xp: 5000 } },
            { rank: 'diamond', level: 6, description: 'Domina todas las regiones.', target: navigationData.length, reward: { bones: 5000, xp: 10000 } },
        ],
        progress: (user) => {
    ...
    },
    {
        ...
        action: { type: 'view', value: 'shop' },
        tiers: [
            { rank: 'bronze', level: 1, description: 'Activa Doble o Nada 3 veces.', target: 3, reward: { xp: 50 } },
            { rank: 'silver', level: 2, description: 'Activa Doble o Nada 10 veces.', target: 10, reward: { bones: 100, xp: 100 } },
            { rank: 'gold', level: 3, description: 'Activa Doble o Nada 25 veces.', target: 25, reward: { bones: 250, xp: 250 } },
            { rank: 'ruby', level: 4, description: 'Activa Doble o Nada 50 veces.', target: 50, reward: { bones: 500, xp: 500 } },
            { rank: 'emerald', level: 5, description: 'Activa Doble o Nada 100 veces.', target: 100, reward: { bones: 1000, xp: 1000 } },
            { rank: 'diamond', level: 6, description: 'Activa Doble o Nada 200 veces.', target: 200, reward: { bones: 2000, xp: 2000 } },
        ],
